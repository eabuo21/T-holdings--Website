    ...
    <>
      <div className="fade-in-who">
        ...
        <main className="main-about">
          ...
          <section className="about-order2">
            <div className="about-order2-content">
              <div className="about-order2-text-content">
                <div data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="1000" className="about-order2-text">
                  <h1>Who We Are</h1>
                  <p>
                    {" "}
              ...
              <div className="about-order2-text-content">
                <div className="Ceo"
                  data-aos="fade-left" data-aos-easing="ease-in" data-aos-duration="1000" className="about-order2-image">
                  <img
          ...
          <section className="our-cultures" style={{position: 'relative', paddingtop: '0'}}>
            <Hidden />
          </section>
